...
def seed_database():
    ...
    usuarios = [
        ...
        {'nombre': 'Patricia', 'apellidos': 'Ramírez', 'email': 'patricia.ramirez@example.com', 'password': generate_password_hash('password'), 'telefono': '2233445566', 'rol': 'User', 'codigo_acceso': 4, 'acepto_terminos': True,'hogar_id':4},
